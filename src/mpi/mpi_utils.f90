...
contains
   ...
   subroutine allocate_state(state, do)
      implicit none
   ...
   subroutine allocate_state_memory(state, do, memory)
      implicit none
   ...
   subroutine deallocate_state(state, do, memory)
      implicit none
      type(state_t), intent(inout) :: state
      type(control_t), intent(in)  :: do
      type(memory_t), intent(inout)  :: memory
   ...
   subroutine broadcast_state(state, do)
      implicit none
      type(state_t), intent(inout) :: state
      type(control_t), intent(in) :: do
      integer :: ierr
